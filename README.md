[![logo](https://raw.githubusercontent.com/antoniomika/samba/main/logo.jpg)](https://www.samba.org)
...
## Hosting a Samba instance
    ...
    sudo docker run -it -p 139:139 -p 445:445 -d ghcr.io/antoniomika/samba -p

OR set local storage:

    sudo docker run -it --name samba -p 139:139 -p 445:445 \
                -v /path/to/directory:/mount \
                -d ghcr.io/antoniomika/samba -p

## Configuration

    sudo docker run -it --rm ghcr.io/antoniomika/samba -h
...
### Setting the Timezone
    ...
    sudo docker run -it -e TZ=EST5EDT -p 139:139 -p 445:445 -d ghcr.io/antoniomika/samba -p
...
through a [GitHub issue](https://github.com/ghcr.io/antoniomika/samba/issues).